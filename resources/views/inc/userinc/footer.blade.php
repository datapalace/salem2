        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 width-25 mb-30">
              ...
              <div class="font-md mb-20 color-gray-900"><strong class="font-md-bold">E-mail:</strong> contact@salemapparels.com</div>
            ...
            <div class="col-lg-4 width-20 mb-30">
              <h4 class="mb-30 color-gray-1000">Quick Link</h4>
