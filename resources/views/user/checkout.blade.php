                    ...
                    <div class="col-lg-6">
                        <div class="box-border">
                            <div class="box-payment"><a class="btn btn-gpay"><img
                                        src="{{ asset('userasset/imgs/page/checkout/gpay.svg') }}" alt="Ecom"></a><a
                                    class="btn btn-paypal"><img src="{{ asset('userasset/imgs/page/checkout/paypal.svg') }}"
                                        alt="Ecom"></a><a class="btn btn-amazon"><img
                                        src="{{ asset('userasset/imgs/page/checkout/amazon.svg') }}" alt="Ecom"></a>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <h5 class="font-md-bold color-brand-3 text-sm-start text-center">
                                    {{ Auth::guard('customer')->user() ? 'Hi ' . $user->name : 'You are not logged in' }}
                                </h5>
                                <div class="border-bottom-4 text-center mb-20">
                                    ...
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            ...
                                            <button class="nav-link text-warning" id="nav-profile-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="nav-profile" aria-selected="false">Register</button>
                                            ...
                                            <form action="{{ route('process.login') }}" method="post">
                                                ...
                                                <div class="form-register mt-30 mb-30">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control font-sm" type="text" name="username"
                                                            placeholder="Email">
                                                    </div>
                                                    <div class="form-group">

                                                        <input class="form-control font-sm" type="password" name="password"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 text-end">
                                                            <div class="form-group"><a class="font-xs color-gray-500"
                                            ...
                                            <form action="{{ route('register') }}" method="post">
                                                ...
                                                <div class="form-register mt-30 mb-30">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control font-sm" type="text" name="name"
                                                            placeholder="Full name" required>
                                                    </div>
                                                    <div class="form-group">

                                                        <input class="form-control font-sm" type="text" name="email"
                                                            placeholder="Email" required>
                                                    </div>
                                                    <div class="form-group">

                                                        <input class="form-control font-sm" name="username"
                                                            type="text" placeholder="username" required>
                                                    </div>
                                                    <div class="form-group">

                                                        <input class="form-control font-sm" id="password"
                                                            type="password" name="password" required
                                                            placeholder="Password">
                                                    </div>
                                                    <div class="form-group">

                                                        <input class="form-control font-sm" required id="repassword"
                                                    ...
                                                    <div class="form-group">
                                                        <label>
                                                            <input class="checkagree" id="checkagree" type="checkbox">By
                                                            clicking Register button, you agree our terms and policy,
                                                        </label>
                                                        <br>
                                                        <small id="agreementHelp" class="text-danger"
                                                            style="display:none;">You must agree to the terms and
                                                            policy.</small>
                                                    </div>
                                                    <div class="form-group">
                                                        <button class="font-md-bold btn btn-buy" id="signupBtn"
                            ...
                            <form id="checkOutForm" method="POST" action="{{ route('checkout.stripe.pay') }}">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input class="form-control font-sm" name="city" type="text"
                                                placeholder="City*">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input class="form-control font-sm" name="zip_code" type="text"
                                                placeholder="PostCode / ZIP*">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <input class="form-control font-sm" required name="phone" type="tel"
                                                placeholder="Phone *">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-0">
                                            ...
                                            <input type="hidden" name="stripe_payment_ref" id="stripePaymentRef"
                                                value="">
                                            {{-- additional information --}}
                                            <textarea class="form-control font-sm" name="additional_information" placeholder="Additional Information"
                                                rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6">
                    <div class="box-border">
                                ...
                                <div class="wishlist-product">
                                    <div class="product-wishlist">
                                        <div class="product-image">
                                            <a href="#">
                                                <img src="{{ $c['custom_image'] ?? asset('userasset/imgs/page/product/img-sub.png') }}"
                                                    alt="Product" class="img-fluid mb-2">
                                            </a>
                                ...
                                <div class="mt-2">
                                    ...
                                    @endif --}}
                                        ...
                                        <div class="product-info">
                                            ...
                                            <p class="text-muted mb-1">Decoration:
                                                {{ ucfirst($c['decoration_type']) ?? '-' }}</p>

                                            <p class="text-muted mb-1">
                                                Color:
                                                <span class="d-inline-block align-middle"
                                                    style="width: 16px; height: 16px; background-color: {{ $c['color'] ?? '#000' }}; border-radius: 4px; border: 1px solid #ccc;"></span>
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="row mb-10">
                                <div class="col-lg-6 col-6"><span class="font-md-bold color-brand-3">Cost Breakdown</span>
                                </div>
                                    ...
                                    <div class="box-border mt-4">
                                        ...
                                        @foreach ($c['custom_designs'] as $i => $design)
                                            @php
                                                ...
                                                if (
                                                    isset($design['decoration']) &&
                                                    strtolower($design['decoration']) === 'print'
                                                ) {
                                                    $totalDesignCost +=
                                                        13 * collect(json_decode($c['sizes'], true))->sum();
                                                } elseif (
                                                    isset($design['decoration']) &&
                                                    strtolower($design['decoration']) === 'embroidery'
                                                ) {
                                                    $totalDesignCost +=
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        @if (isset($design['decoration']) && strtolower($design['decoration']) === 'print')
                                                            £13 <span class="text-muted"> x
                                                                {{ collect(json_decode($c['sizes'], true))->sum() }}
                                                                ({{ 13 * collect(json_decode($c['sizes'], true))->sum() }})</span>
                                                        @elseif(isset($design['decoration']) && strtolower($design['decoration']) === 'embroidery')
                                                            £15 <span class="text-muted"> x
                                                                {{ collect(json_decode($c['sizes'], true))->sum() }}
                                                                ({{ 15 * collect(json_decode($c['sizes'], true))->sum() }})</span>
                                                        @else
                                                            -
                                                        @endif
                                                        <br>
                            ...
                            @if ($c['decoration_type'] === 'embroidery')
                                <div class="row mb-10">
                                    <div class="col-lg-6 col-6"><span class="font-md-bold color-brand-3">Embroidery
                                            Price</span></div>
                                    <div class="col-lg-6 col-6 text-end"><span> <span
                                                class="font-lg-bold color-brand-3">£{{ number_format($c['embroidery_price'], 2) * collect(json_decode($c['sizes'], true))->sum() }}</span><br>
                                            <small
                                                style="font-size: 10px;">({{ number_format($c['embroidery_price'], 2) }} x
                                                {{ collect(json_decode($c['sizes'], true))->sum() }})</small></span></div>

                                </div>
                                <div class="row mb-10">
                                    <div class="col-lg-6 col-6"><span class="font-md-bold color-brand-3">Digitisation
                                            Setup</span></div>
                                    <div class="col-lg-6 col-6 text-end"><span
                                            class="font-lg-bold color-brand-3">£{{ number_format(15, 2) }}</span></div>

                                </div>
                            @endif
                            <div class="border-bottom mb-10 pb-5">
                                <div class="row">
                                    <div class="col-lg-6 col-6"><span class="font-md-bold color-brand-3">Quantity</span>
                                    </div>
                                    <div class="col-lg-6 col-6 text-end"><span
                                            class="font-lg-bold color-brand-3">{{ collect(json_decode($c['sizes'], true))->sum() }}</span><br>
                                        <span>
                            ...
                            <div class="border-bottom mb-10 pb-5">
                                <div class="row">
                                    <div class="col-lg-6 col-6"><span class="font-md-bold color-brand-3">Shipping</span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-6"><span class="font-md-bold color-brand-3">Product Cost</span>
                                </div>
                                <div class="col-lg-6 col-6 text-end"><span class="font-lg-bold color-brand-3">£
                                        {{ number_format($c['total_price'], 2) }}

                                    </span></div>
                                <div class="col-lg-6 col-6"><span class="font-md-bold color-brand-3">Design Cost</span>
                                </div>
                                <div class="col-lg-6 col-6 text-end"><span class="font-lg-bold color-brand-3">£
                                        {{ number_format($totalDesignCost, 2) }}

                                    </span></div>
                                <div class="col-lg-6 col-6"><span class="font-md-bold color-brand-3">Total Cost</span>
                            ...
                            <div class="row mt-20">
                                ...
                                <div class="col-lg-6 col-7 mb-20 text-end float-right"><button id="payBtn"
                                        class="btn btn-buy w-auto arrow-next"
                                        {{ !Auth::guard('customer')->user() ? 'disabled' : '' }}>Pay Now</button>
