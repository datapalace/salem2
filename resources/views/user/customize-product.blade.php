            ...
            <div class="row">
                        ...
                        <div class="galleries">
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    <!-- <figure class="border-radius-10"><img src="{{ $product->galleries[0]->image_url }}" alt="product image"></figure> -->
                                    <!-- <figure class="border-radius-10"><img src="{{ $product->galleries[1]->image_url }}" alt="product image"></figure>
                                    <figure class="border-radius-10"><img src="{{ $product->galleries[2]->image_url }}" alt="product image"></figure>
                                    <figure class="border-radius-10"><img src="{{ $product->galleries[3]->image_url }}" alt="product image"></figure>
                                    <figure class="border-radius-10"><img src="{{ $product->galleries[4]->image_url }}" alt="product image"></figure> -->
                                </div>
                            </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="box-product-price">
                        <h3 class="color-brand-3 price-main d-inline-block mr-10">£{{ $product->price->single_list_price + 3 ?? 'N/A' }}</h3>
