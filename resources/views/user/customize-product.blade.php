        ...
        <div class="container">
          <div class="pt-30 mb-10">
            <ul class="nav nav-tabs nav-tabs-product" role="tablist">
              ...
              <li><a href="#tab-specification" data-bs-toggle="tab" role="tab" aria-controls="tab-specification" aria-selected="true">Certifications</a></li>
              ...
              <div class="list-products-5 mt-20">
                ...
                <div class="card-grid-style-3">
                  <div class="card-grid-inner">
                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="shop-wishlist.html" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="/product/customize/{{$relatedProduct->product->id}}" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                    <div class="image-box"><span class="label bg-brand-2">-17%</span><a href="/product/customize/{{$relatedProduct->product->id}}"><img src="{{ $relatedProduct->product->galleries[0]->image_url }}" alt="Ecom"></a></div>
                    <div class="info-right"><a class="font-xs color-gray-500" href="shop-vendor-single.html">{{$relatedProduct->product->type}}</a><br><a class="color-brand-3 font-sm-bold" href="/product/customize/{{$relatedProduct->product->id}}">{{$relatedProduct->product->title. ' ' .$relatedProduct->product->sku}}</a>
                      ...
                      <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">£{{$relatedProduct->product->price->single_list_price + 3}}</strong>
                      <!-- <span class="color-gray-500 price-line">$3225.6</span> -->
                    </div>
                      <div class="mt-20 box-btn-cart"><a class="btn btn-cart" href="/product/customize/{{$relatedProduct->product->id}}">Add To Cart</a></div>
