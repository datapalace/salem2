...
@section('usercontent')
<title>Customise Shop - Salem Apparel</title>
        ...
        <div class="breadcrumbs-div">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li><a class="font-xs color-gray-500" href="/customise-shop">Shop</a></li>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                            <div class="card-grid-style-3">
                                <div class="card-grid-inner" style="border: 1px, solid, #E2B808;">
                                    <div class="tools"><a class="btn btn-trend btn-tooltip mb-10" href="#" aria-label="Trend" data-bs-placement="left"></a><a class="btn btn-wishlist btn-tooltip mb-10" href="/product/customise/{{  $product->slug }}" aria-label="Add To Wishlist"></a><a class="btn btn-compare btn-tooltip mb-10" href="/customise-shop" aria-label="Compare"></a><a class="btn btn-quickview btn-tooltip" aria-label="Quick view" href="#ModalQuickview" data-bs-toggle="modal"></a></div>
                                    <div class="image-box">
                                        {{-- <span class="label bg-brand-2">-17%</span> --}}
                                        <a href="/product/customise/{{  $product->slug }}">
                                            <img src="{{ asset('storage/' . $product->galleries->first()?->image_url) ?? asset('userasset/imgs/template/no-image.png') }}" alt="Salem Apparels">
                                        </a>
                                    </div>
                                    <div class="info-right"><a class="font-xs color-gray-500" href="/shop">{{ $product->brand }}</a><br><a class="color-brand-3 font-sm-bold" href="/product/customise/{{  $product->slug }}">{{ $product->title . ' ' . $product->sku }}</a>
                                        <div class="price-info"><strong class="font-lg-bold color-brand-3 price-main">£{{ $product->price->single_list_price ?? 'N/A' }}</strong></div>
