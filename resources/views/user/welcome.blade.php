...
@section('usercontent')
    <title>Salem Apparel - Home</title>
                                ...
                                <div class="swiper-container swiper-group-1 h-100" style="width:100vw; height:100vh;">
                                    <div class="swiper-wrapper h-100" style="width:100vw; height:100vh;">
                                        ...
                                        <div class="swiper-slide h-100" style="width:100vw; height:100vh;">
                                            <img src="{{ asset('userasset/imgs/slider/swiper/1.png') }}" width="100%"
                                                alt="" >
                                        </div>
                                        <div class="swiper-slide h-100" style="width:100vw; height:100vh;">
                                            <img src="{{ asset('userasset/imgs/slider/swiper/6.png') }}" width="100%"
                                                alt="" >
                                        </div>
                                        <div class="swiper-slide h-100" style="width:100vw; height:100vh;">
                                            <img src="{{ asset('userasset/imgs/slider/swiper/3.png') }}" width="100%"
                                                alt="" >

                                        </div>
                                        <div class="swiper-slide h-100" style="width:100vw; height:100vh;">
                                            <img src="{{ asset('userasset/imgs/slider/swiper/4.png') }}" width="100%"
                                                alt="" >
                                        </div>
                                        <div class="swiper-slide h-100" style="width:100vw; height:100vh;">
                                            <img src="{{ asset('userasset/imgs/slider/swiper/5.png') }}" width="100%"
                                                alt="" >
                                        </div>
                                        <div class="swiper-slide h-100" style="width:100vw; height:100vh;">
                                            <img src="{{ asset('userasset/imgs/slider/swiper/7.png') }}" width="100%"
                                                alt="" >
                                        </div>
                        ...
                        <div class="swiper-container swiper-group-10">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><a href="#"><img
                                            src="{{ asset('userasset/imgs/slider/logo/awdis.png') }}"
                                            style="max-height: 50px; width: auto; opacity: 0.8; object-fit: contain;"
                                            alt="Salem Apparel"></a></div>
                                <div class="swiper-slide"><a href="#"><img
                                            src="{{ asset('userasset/imgs/slider/logo/adc.avif') }}"
                                            style="max-height: 50px; width: auto; opacity: 0.8; object-fit: contain;"
                                            alt="Salem Apparel"></a></div>
                                <div class="swiper-slide"><a href="#"><img
                                            src="{{ asset('userasset/imgs/slider/logo/anthem.jpg') }}"
                                            style="max-height: 50px; width: auto; opacity: 0.8; object-fit: contain;"
                                            alt="Salem Apparel"></a></div>
                                <div class="swiper-slide"><a href="#"><img
                                            src="{{ asset('userasset/imgs/slider/logo/bagbase.png') }}"
                                            style="max-height: 50px; width: auto; opacity: 0.8; object-fit: contain;"
                                            alt="Salem Apparel"></a></div>
                                <div class="swiper-slide"><a href="#"><img
                                            src="{{ asset('userasset/imgs/slider/logo/brook.png') }}"
                                            style="max-height: 50px; width: auto; opacity: 0.8; object-fit: contain;"
                                            alt="Salem Apparel"></a></div>
                                <div class="swiper-slide"><a href="#"><img
                                            src="{{ asset('userasset/imgs/slider/logo/baby.jpg') }}"
                                            style="max-height: 50px; width: auto; opacity: 0.8; object-fit: contain;"
                                            alt="Salem Apparel"></a></div>
                                                ...
                                                <div class="card-grid-style-3">
                                                    <div class="card-grid-inner">
                                                        <div class="tools"><a class="btn btn-trend btn-tooltip mb-10"
                                                                ...
                                                                class="btn btn-wishlist btn-tooltip mb-10" href="#"
                                                                aria-label="Add To Wishlist"></a><a
                                                                class="btn btn-compare btn-tooltip mb-10" href="#"
                                                        ...
                                                        <div class="image-box"><a
                                                                href="/product/customise/{{ $product->slug }}"><img
                                                                    src="{{ $product->galleries->first()?->image_url ?? asset('userasset/imgs/template/no-image.png') }}"
                                                                    alt="{{ $product->title }}" alt="Salem Apparel"></a>
                                                        </div>
                                                        <div class="info-right"><a class="font-xs color-gray-500"
                                                            ...
                                                            <div class="mt-20 box-btn-cart"><a class="btn btn-cart"
                                                                    href="/product/customise/{{ $product->slug }}">Customise</a>
                                                            </div>
                                                            <ul class="list-features">
                                                                @foreach ($product->attributes as $attribute)
                                                                    <li>{{ Str::replace(':', ': ', $attribute->attribute) }}
                                                                    </li>
                                                                @endforeach
                                                        ...
                                                        <div class="card-grid-style-3">
                                                            <div class="card-grid-inner">
                                                                <div class="tools"><a
                                                                        ...
                                                                        href="#" aria-label="Add To Wishlist"></a><a
                                                ...
                                                @foreach ($footwears as $product)
                                                    <div
                                                        ...
                                                        <div class="info-right"><a class="color-brand-3 font-xs-bold"
                                                                href="/product/customise/{{ $product->slug }}">{{ $product->title }}
                                                            </a>
