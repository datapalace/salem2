                                        ...
                                        @foreach ($bannerProducts as $bp)
                                            <div class="swiper-slide">
                                                <div class="banner-big sbanner-big-3 bg-22"
                                                    ...
                                                    <img src="{{ $bp->galleries[0]->image_url }}"
                                ...
                                <div class="col-xl-5 col-lg-3 col-md-4 col-sm-12">
                                    <div class="box-promotions">
                                        ...
                                        <div class="swiper swiper-vertical-1">
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide"><a href="shop-list-2.html"><img
                                                            src="{{ asset('userasset/imgs/page/homepage4/promotion1.png') }}"
                                                            alt="Ecom"></a><a href="shop-list-2.html"><img
                                                            src="{{ asset('userasset/imgs/page/homepage4/promotion2.png') }}"
                                                            alt="Ecom"></a><a href="shop-list-2.html"><img
                                                            src="{{ asset('userasset/imgs/page/homepage4/promotion3.png') }}"
                                                            alt="Ecom"></a><a href="shop-list-2.html"><img
                                                            src="{{ asset('userasset/imgs/page/homepage4/promotion4.png') }}"
                                                            alt="Ecom"></a><a href="shop-list-2.html"><img
                                                            src="{{ asset('userasset/imgs/page/homepage4/promotion5.png') }}"
                                                            alt="Ecom"></a><a href="shop-list-2.html"><img
                                                            src="{{ asset('userasset/imgs/page/homepage4/promotion6.png') }}"
                                                            alt="Ecom"></a></div>
                                                <div class="swiper-slide"><a href="shop-list-2.html"><img
                                                            src="{{ asset('userasset/imgs/page/homepage4/promotion2.png') }}"
                                                            alt="Ecom"></a><a href="shop-list-2.html"><img
                        ...
                        <div class="swiper-container swiper-group-10">
                            <div class="swiper-wrapper">
                                @foreach ($brands as $brand)
                                     <div class="swiper-slide"><h6>{{  $brand->brand }}</h6> </div>
                                @endforeach
            ...
            <div class="container">
                <div class="row mt-60">
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="card-grid-style-2 card-grid-style-2-small">
                            <div class="image-box"><a href="shop-fullwidth.html"><img
                                        src="{{ asset('userasset/imgs/page/homepage1/smartphone.png') }}"
                                        alt="Ecom"></a>
                                <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View
                                        all</a></div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="card-grid-style-2 card-grid-style-2-small">
                            <div class="image-box"><a href="shop-fullwidth.html"><img
                                        src="{{ asset('userasset/imgs/page/homepage1/television.png') }}"
                                        alt="Ecom"></a>
                                <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View
                                        all</a></div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="card-grid-style-2 card-grid-style-2-small">
                            <div class="image-box"><a href="shop-fullwidth.html"><img
                                        src="{{ asset('userasset/imgs/page/homepage1/computer.png') }}"
                                        alt="Ecom"></a>
                                <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View
                                        all</a></div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                        <div class="card-grid-style-2 card-grid-style-2-small">
                            <div class="image-box"><a href="shop-fullwidth.html"><img
                                        src="{{ asset('userasset/imgs/page/homepage1/electric.png') }}"
                                        alt="Ecom"></a>
                                <div class="mt-10 text-center"><a class="btn btn-gray" href="shop-fullwidth.html">View
                                        all</a></div>
                            </div>
